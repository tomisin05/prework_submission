...
const displayString = `A total of $${totalContributions.toLocaleString()} has been raised for ${totalGames.toLocaleString()} games. Currently, ${unfundedGames > 0 ? unfundedGames.toLocaleString() + " games" : "1 game" } remains unfunded. We need your help to fund these amazing games!`
